...
<head>
 ...
 <div class="container-fluid bg-dark px-0">
    ...
    <div class="container-fluid p-5">
        <!-- <div class="mb-5 text-center">
            <h1 class="display-3 text-uppercase mb-0">Services</h1>
        </div> -->
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="team-item position-relative">
                    <div class="position-relative overflow-hidden rounded">
                        ...
                        <img class="img-fluid w-100" src="../images/images/products/<?php echo($item['product_image']) ?>" alt="lmg">
                        </a>
                        <div class="team-overlay">
                            <div class="d-flex align-items-center justify-content-start">
                                <a class="btn btn-light btn-square rounded-circle mx-1" href="single_product.php?product_id=<?php echo($item['product_id'])?>"><i class="fa fa-eye"></i></a>
                    ...
                    <div class="position-absolute start-0 bottom-0 w-100 rounded-bottom text-center p-4" style="background: rgba(34, 36, 41, .9);">
                        <h5 class="text-uppercase text-light"><?php echo($item['product_title'])?></h5>
                        <p class="text-uppercase text-secondary m-0">GHC <?php echo($item['product_price'])?></p>
                        <p class="text-uppercase text-secondary m-0"><?php echo($item['product_desc'])?></p>
