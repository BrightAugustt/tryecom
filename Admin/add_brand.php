        ...
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
             ...
             <form action="../actions/addbrand.php" onsubmit="validate()" method="POST">
                <div class="form-group">
                  <label for="brand_name">  Brand Name</label>
                  <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Brand Name" name="brand_name" required>
                </div>
                    <div class="col-sm-10" style="margin-top: 15px;">
                      <button type="submit" class="btn btn-primary" name="addbrand">Submit Form</button>
                </form>
                    </div>
                  </div>
            </div>
