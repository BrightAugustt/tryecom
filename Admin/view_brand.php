                        ...
                        <div class='modal-dialog' role='document'>
                          <div class='modal-content'>
                            ...
                            <div class='modal-body'>
                              <form action='../actions/updatebrandprocess.php' method='POST'>
                                 <div class='formgroup'>
                                    <input type='hidden' name='brand_id' value= '".$result[$i]['brand_id']."'>
                                </div>
                                <div class='form-group'>
                                  <label for='recipient-name' class='col-form-label'>Brand Name:</label>
                                  <input type='text' class='form-control' id='brand_name' name='brand_name' required placeholder= '".$result[$i]['brand_name']."'>
                                  <input type='hidden' name='brand_id'  value= '".$result[$i]['brand_id']."'>
                                </div>
                                <div class='modal-footer'>
                                <button type='button' class='btn btn-secondary' data-dismiss='modal'>Cancel</button>
                                <input type = 'submit' value='update' name='updatebrand' class='btn btn-primary'>
                                <input type='hidden' name='brand_id' value='".$result[$i]['brand_id']."'>
                              </div>
                              </form>
