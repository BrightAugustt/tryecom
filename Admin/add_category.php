            ...
            <div class="card-body">
             ...
             <form action="../actions/addcatprocess.php" onsubmit="validate()" method="POST">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Brand Name" name="cat_name" required>
                </div>
                    <div class="col-sm-10" style="margin-top: 15px;">
                      <button type="submit" class="btn btn-primary" name="addcategory">Submit Form</button>
                </form>
            </div>
          </div>
