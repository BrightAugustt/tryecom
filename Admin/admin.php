...
<ul class="sidebar-nav" id="sidebar-nav">
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">Category of Products</h5>
        <p class="card-text">View all product categories</p>
        <a href="view_cat.php" class="btn btn-primary">Category</a>
      </div>
    </div>
  </div>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">Brand of products</h5>
        <p class="card-text">View all brands of products</p>
        <a href="view_brand.php" class="btn btn-primary">Brands</a>
      </div>
    </div>
  </div>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text">View all product services created for customers</p>
        <a href="view_product.php" class="btn btn-primary">Products</a>
      </div>
    </div>
  </div>
